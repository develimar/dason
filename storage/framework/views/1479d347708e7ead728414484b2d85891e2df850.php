                        ...
                        <div class="d-flex flex-column h-100">
                            <div class="mb-4 mb-md-5 text-center">
                                <a href="<?php echo e(url('/')); ?>" class="d-block auth-logo">
                                    <img src="<?php echo e(URL::asset('assets/images/logo-sm.svg')); ?>" alt="" height="28"> <span class="logo-txt">Monitor</span>
                                </a>
                            </div>
                            <div class="auth-content my-auto">
                                <div class="text-center">
                                    <h5 class="mb-0">Bem Vindo !</h5>
                                    <p class="text-muted mt-2">Entre com as Informaçõs Solicitadas.</p>
                                </div>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="mt-5 text-center">
                                    <p class="text-muted mb-0">Não Tem uma conta ? <a href="<?php echo e(url('register')); ?>"
                                            class="text-primary fw-semibold"> Criar </a> </p>
                                </div>
                            </div>
                            <div class="mt-4 mt-md-5 text-center">
                                <p class="mb-0">© <script>document.write(new Date().getFullYear())</script> Monitor   . Criado <i class="mdi mdi-heart text-danger"></i> by Elimar</p>
                            </div>
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.master-without-nav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\dason\resources\views/auth/login.blade.php ENDPATH**/ ?>